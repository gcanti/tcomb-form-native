...
function datepicker(locals) {
  ...
  var formattedDateValue = new Date(locals.value).toDateString()
  var formattedTimeValue = new Date(locals.value).toTimeString()
  if (locals.config) {
        ...
        <View>
          ...
          <TouchableNativeFeedback
            ...
            onPress={function() {
              ...
              let setTime = {
                hour: isDate
                  ? new Date(locals.value).getHours()
                  : now.getHours(),
                minute: isDate
                  ? new Date(locals.value).getMinutes()
                  : now.getMinutes()
              }
